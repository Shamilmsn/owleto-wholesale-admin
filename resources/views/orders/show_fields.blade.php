...
<div class="form-group row col-md-4 col-sm-12">
    ...
    <div class="col-8">
    <p>{!! $order->payment_method_id == \App\Models\PaymentMethod::PAYMENT_METHOD_WALLET ? 'Wallet' : optional($order->paymentMethod)->name  !!}</p>
  </div>
...
<div class="form-group row col-md-4 col-sm-12">
    ...
    <div class="col-8">
        @if(isset($order->productOrders[0]))
            <p>{!! $order->productOrders[0]->product->market->phone ?:  $order->productOrders[0]->product->market->mobile !!}</p>
        @endif
    </div>
