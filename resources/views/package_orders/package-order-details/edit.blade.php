  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{!! route('package-orders.index') !!}"><i class="fa fa-list mr-2"></i>{{trans('lang.order_table')}}</a>
        </li>
        @endcan
        <li class="nav-item">
    ...
    <div class="card-body">
      {!! Form::model($order, ['route' => ['package-order-details.update', $order->id], 'method' => 'patch']) !!}
      <div class="row">
