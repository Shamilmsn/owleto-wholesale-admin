...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Today's package orders</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                @include('package_orders.current-date.table')
                <div class="clearfix"></div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="drivers-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form method="post" action="{{url('assign-driver-to-todays-package-orders')}}">
                    @csrf
