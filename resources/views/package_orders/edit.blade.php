...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">{{trans('lang.package_order_plural')}}
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        @endcan
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-pencil mr-2"></i>{{trans('lang.package_order_edit')}}</a>
        </li>
      </ul>
    </div>
    <div class="card-body">
      {!! Form::model($order, ['route' => ['package-orders.update', $order->id], 'method' => 'patch']) !!}
      <div class="row">
        @include('package_orders.fields')
      </div>
      {!! Form::close() !!}
      <div class="clearfix"></div>
    </div>
