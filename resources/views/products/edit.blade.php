...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">{{trans('lang.product')}} - {{ $product->name }}
...
<div class="content">
  ...
  <div class="card">
    ...
    <div class="card-body">
      {!! Form::model($product, ['route' => ['products.update', $product->id], 'method' => 'patch', 'id' => 'form-update']) !!}
      <div class="row">
...
<div class="variant-product-template d-none">
