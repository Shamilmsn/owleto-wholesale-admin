...
@section('content')
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                {!! Form::model($term, ['route' => ['terms.update', $term->id], 'method' => 'patch', 'id' => 'form-update']) !!}
                @method('PUT')
                <div class="row">
                    <div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
                        <div class="form-group row ">
                            ...
                            <div class="col-9">
                                {!! Form::select('type', $types, $term->type, ['class' => 'select2 form-control']) !!}
                    ...
                    <input type="hidden" id="editorContent"
                           value="{{$term->terms_and_conditions}}"
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const initialContent = JSON.parse(editorContent);
