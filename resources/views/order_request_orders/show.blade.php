...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">{{trans('lang.order_request_orders_plural')}}
        ...
        <div class="card">
            <div class="card-header d-print-none">
                <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.order_request_order')}}</a>
                    </li>
            ...
            <div class="card-body">
                <div class="row">
                    @include('order_request_orders.show_fields')
                </div>
...
{{--                                    </tr>--}}
                ...
                <div class="row d-print-none">
                    ...
                    <div class="form-group col-12 text-right">
                        <a href="{!! route('order-request-orders.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.back')}}</a>
                    </div>
                </div>
                <div class="clearfix"></div>
            </div>
