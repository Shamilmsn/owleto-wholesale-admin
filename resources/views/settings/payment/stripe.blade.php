        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <!-- 'Boolean enable_facebook Field' -->
                    ...
                    <div class="form-group row col-12">
                        {!! Form::label('stripe_webhook_secret', trans('lang.app_setting_stripe_webhook_secret'), ['class' => 'col-3 control-label text-right']) !!}
                        <div class="col-9">
                            {!! Form::text('stripe_webhook_secret', setting('stripe_webhook_secret'),  ['class' => 'form-control','placeholder'=>  trans('lang.app_setting_stripe_webhook_secret_placeholder')]) !!}
                            <div class="form-text text-muted">
                                {!! trans('lang.app_setting_stripe_webhook_secret_help') !!}
                            </div>
                        </div>
                    </div>
                </div>
