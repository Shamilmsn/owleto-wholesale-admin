...
<table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        <td class="innerpadding borderbottom" style="padding-top: 0px;">
            ...
            <br />
            <br />
            Your payment of {{ $attributes['amount'] }} Rs. towards the order with OrderID {{ $attributes['order_id'] }}. has been successfully completed <br><br>
            Thanks & Regards <br>
            Owleto
        </td>
    </tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td align="center" class="footercopy" style="color: black;">
                        © {{ date('Y') }} Owleto, All rights reserved.
                    </td>
                </tr>
                </tbody>
            </table>
