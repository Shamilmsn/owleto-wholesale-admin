<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::number('tax', null,  ['class' => 'form-control', 'disabled' => 'disabled', 'step'=>"any",
                'placeholder'=>  trans("lang.order_tax_placeholder")]) !!}
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::number('delivery_fee', null,  ['class' => 'form-control', 'disabled' => 'disabled',
                        'step'=>"any",'placeholder'=>  trans("lang.order_delivery_fee_placeholder")]) !!}
            <div class="form-text text-muted">
...
<div class="form-group col-12 text-right">
    ...
    <a href="{!! route('pickup-delivery-orders.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.cancel')}}</a>
</div>
