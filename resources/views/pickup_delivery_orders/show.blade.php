        ...
        <div class="card">
            <div class="card-header d-print-none">
                <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.pickup_order')}}</a>
                    </li>
            ...
            <div class="card-body">
                <div class="row">
                    @include('pickup_delivery_orders.show_fields')
                </div>
...
{{--                                    </tr>--}}
                ...
                <div class="row d-print-none">
                    ...
                    <div class="form-group col-12 text-right">
                        <a href="{!! route('pickup-delivery-orders.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.back')}}</a>
                    </div>
                </div>
                <div class="clearfix"></div>
            </div>
