    ...
    <div class="card">
      <div class="card-header d-print-none">
        <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
          <li class="nav-item">
            <a class="nav-link" href="{!! route('pickup-orders.index') !!}"><i class="fa fa-list mr-2"></i>{{trans('lang.order_table')}}</a>
          </li>
          <li class="nav-item">
      ...
      <div class="card-body">
        <div class="row">
          @include('pick-up-orders.show_fields')
        </div>
        ...
        <div class="row d-print-none">
          <div class="form-group col-12 text-right">
            <a href="{!! route('pickup-orders.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.back')}}</a>
          </div>
        </div>
        <div class="clearfix"></div>
      </div>
