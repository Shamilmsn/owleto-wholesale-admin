<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    <input type="hidden" value="{{ $marketPayoutRequest->market_id }}" name="market_id">
    <input type="hidden" value="{{ $marketPayoutRequest->id }}" name="payout_request_id">
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::number('amount', $marketPayoutRequest->amount-$marketPayoutRequest->paid_amount,  ['class' => 'form-control','step'=>"any", 'placeholder'=>  trans("lang.drivers_payout_amount_placeholder")]) !!}
...
<div class="form-group col-12 text-right">
  ...
  <a href="{!! route('market-payout-requests.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.cancel')}}</a>
</div>
