    ...
    <div class="card-body">
      ...
      <div class="row">
        ...
        <div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
          ...
          <div class="form-group row ">
            {!! Form::label('closed', 'Is Sub Category?',['class' => 'col-3 control-label text-right']) !!}
            <div class="checkbox">
          ...
          <div class="form-group row d-none" id="sub-category-row">
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#subcategory_checkbox').change(function() {
        if (this.checked) {
           $("#sub-category-row").removeClass('d-none')
        }
        else {
          $("#sub-category-row").addClass('d-none')
        }
      });
    });
  </script>
