...
class PickUpDeliveryOrderRequestDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
                    ...
                    ->addColumn('action', function ($attribute){
                        return view('pickup-delivery-order-requests.datatables_actions', compact('attribute'));
                    })
     ...
     *
     * @param \App\Models\PickUpDeliveryOrderRequest $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(PickUpDeliveryOrderRequest $model)
    {
...
//                ],
    ...
    {
        return 'pickup_delivery_order_requests_datatable_' . time();
    }
