...
class OrderStatusDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('fields', function ($order_status) {
                return getLinksColumnByRouteName($order_status->orderStatusFields, 'fields.edit', 'id', 'name');
            })
