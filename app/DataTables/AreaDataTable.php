    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('updated_at',function($query){
                return getDateColumn($query,'updated_at');
            })
...
//            [
//                'data' => 'covered_kilometer',
//                'title' => trans('lang.covered_kilometer'),
//
//            ],
            [
                'data' => 'city.name',
        ...
        $hasCustomField = in_array(Area::class, setting('custom_field_models',[]));
        if ($hasCustomField) {
