...
class User extends Authenticatable implements HasMedia
{
    ...
    const DRIVER_SIGNUP_NOT_DONE_ANYTHING_STATUS = 0;
    const DRIVER_SIGNUP_COMPLETED_LOCALITY_AND_VEHICLE_DETAILS = 1;
    const DRIVER_SIGNUP_COMPLETED_PERSONAL_INFO = 2;
    const DRIVER_SIGNUP_COMPLETED_BANK_INFO = 3;
    const DRIVER_SIGNUP_COMPLETED_PROFILE_UPLOAD = 4;
    const DRIVER_ADMIN_APPROVED = 5;
...
//            ->where('custom_fields.in_table', '=', true)
    ...
    public function getProfileImageUrlAttribute()
    {
        ...
        return url('storage/profile-images/'.$this->profile_image);
    }
