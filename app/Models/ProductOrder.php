...
//        'options'
    ...
    {
        return $this->belongsTo(\App\Models\SubscriptionPackage::class, 'package_id', 'id');
    }
...
//    }
    ...
    {
        return $this->belongsToMany(\App\Models\ProductAddon::class, 'order_addons', 'product_order_id', 'product_addon_id');
    }
}
