...
use Database\Seeders\RefreshPermissionsSeeder;
...
//        $this->call(OrderStatusesFieldTableSeeder::class);
//        $this->call(TShirtSizeSeeder::class);
//        $this->call(DaysTableSeeder::class);
//        $this->call(PickUpVehileSeeder::class);
